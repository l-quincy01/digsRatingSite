...
<div class="TenantContainer" style = "margin-top: 20px; min-height: 800px">


<form action="tableReport2.php" method="Post"  style = "min-height: 600px">
     <h2> <strong>Please select the required report </strong></p>  </h2> <br>  <br>
     <input type ="radio" id="tenants" name="report" value="tenants">
     <label for="tenants"> Tenant registered</label>&nbsp;&nbsp;
     <input type ="radio" id="digs" name="report" value="digs">
     <label for="digs"> Digs registered on the system</label>
     <input type ="radio" id="rated-digs" name="report" value="digsrated">
     <label for="rated-digs"> Digs Per Rating Criteria</label>&nbsp;&nbsp;
     <input type ="radio" id="agents" name="report" value="listings">
     <label for="agents"> Agents with the most Listings</label>
     <br><br>
